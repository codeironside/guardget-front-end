  ...
  const sections = [
      ...
      content: (
        <div className="space-y-4">
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            GuardGet ("we," "our," or "us") is committed to protecting your
            privacy. This Privacy Policy explains how we collect, use, disclose,
            and safeguard your information when you use our device protection
            and verification services, including our website, mobile
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                <strong>Purpose:</strong> To create your account, verify your
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                <strong>Purpose:</strong> To create unique device fingerprints,
                verify ownership, and assist in recovery if stolen.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                <strong>Purpose:</strong> To improve our services, fix bugs, and
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                <strong>Purpose:</strong> To process subscriptions and provide
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              "Verify your identity and device ownership",
              "Process payments and manage subscriptions",
              "Communicate with you about your account and service updates",
              "Monitor and improve the Service's security and performance",
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            We implement robust measures to protect your personal information:
          </p>
                  ...
                  >
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
                      ...
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        Ready to Accept Our Privacy Policy?
                      </h3>
                      <p className="text-gray-600 dark:text-gray-300 mb-6">
                        You've read through our privacy policy. Click below to
                        accept and continue using GuardGet.
                      </p>
                      <motion.button
