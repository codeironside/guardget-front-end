...
const AdminLayout: React.FC = () => {
  ...
  const navigationItems = [
    ...
    { label: 'Devices', icon: <Smartphone size={20} />, path: '/admin/devices' },
    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 text-secondary dark:text-white transition-colors duration-300">
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          {expanded && <h1 className="text-xl font-bold text-primary">Admin Panel</h1>}
        ...
        <nav className="flex-1 pt-6 px-2 space-y-1">
          {navigationItems.map((item, index) => (
            <button
              ...
              className={`flex items-center ${expanded ? 'justify-start' : 'justify-center'} px-4 py-3 rounded-md text-sm font-medium transition-colors w-full ${
                isActive(item.path)
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          <button
            ...
            className={`flex items-center ${expanded ? 'justify-start' : 'justify-center'} px-4 py-3 rounded-md text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors w-full text-error`}
          >
            <LogOut size={20} />
      ...
      >
        <div className={`flex flex-col w-64 max-w-xs bg-white dark:bg-gray-800 transition-transform duration-300 ease-in-out ${
